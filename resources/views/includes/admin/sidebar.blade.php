<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('home') }}" target="_blank">
            <img src="/images/admin.png" class="navbar-brand-img h-100" alt="main_logo" />
            <span class="ms-1 font-weight-bold">Admin - Larastore</span>
        </a>
    </div>
    <div class="collapse navbar-collapse w-auto sidebar-collapse" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('admin/product-gallery*')) ? 'active' : '' }}" href="{{ route('product-gallery.index') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <div class="sidenav-footer mx-3 mt-4">
        <div class="card card-background shadow-none card-background-mask-secondary mt-4" id="sidenavCard">
